...
import { IconBrightnessDown, IconSpace, IconChevronUp, IconBrightnessUp, IconTable, IconSearch, IconMicrophone, IconMoon, IconPlayerSkipForward, IconPlayerTrackNext, IconPlayerTrackPrev, IconVolume, IconVolume2, IconVolume3, IconWorld, IconCommand, IconCaretLeftFilled, IconCaretDownFilled, IconCaretUpFilled, IconCaretRightFilled } from "@tabler/icons-react";
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-110  scale-[0.35] sm:scale-110"
    >
      <motion.h2
        style={{
...
<Row>
  ...
  <KBtn className="" childrenClassName="h-full justify-between py-[4px]">
    <div className="flex justify-start w-full pl-1">
      <IconSpace className="h-[6px] w-[6px]" />
